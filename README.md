...
| Chainlink Payment Abstraction V2 | GPV2CompatibleAuction.sol | Direct bids can consume shared inventory and invalidate pending CoW settlements | Low-Medium / Medium | [Report](./reports/2026-03-chainlink/GPV2CompatibleAuction-cow-order-inventory-preemption.md) | [Issue #8](https://github.com/HUODONGREN/front-run_0day/issues/8) |
